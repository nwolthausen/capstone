...
table(ndd$drink_cat, ndd$control_case_group)

ndd <- ndd %>%
    mutate(F_drink = case_when(drink_cat = 1 ~ 1, 
                                TRUE ~ 0))
...
pca_ndd<- data.frame(ndd$toilet_type, ndd$home,
                     ...
                     ndd$house_roof, ndd$maternal_education)
...
#base model
base_mod<- glm(control_case_group ~ age_months_b+sex+HAZ_b+F_toilet_type+drink_cat,
