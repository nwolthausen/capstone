...
ggplot(data = ndd, aes(x = ndd$diarrhea_days_b)) +
  geom_histogram() +
...
#iron alone
micronut_iron_logit <- glm(control_case_group ~ micro_iron, data=ndd, family="binomial")
summary(micronut_logit)
odds.n.ends(micronut_logit)
#the odds of having diarrhea for those who consumed iron-rich foods are 1.3 times the odds for those who did not
