...
ifelse(ndd$fish>=1|ndd$milk>=1, 1, 0)
...
ndd$micro_zinc[is.na(ndd$micro_zinc)] = 0
...
ndd$micro_iron[is.na(ndd$micro_iron)] = 0
...
ndd$micro_vitamind[is.na(ndd$micro_vitamind)] = 0
