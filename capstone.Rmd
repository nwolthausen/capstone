...
pca_ndd<- data.frame(ndd$toilet_type, ndd$home,
                     ndd$livestock, ndd$telephone, ndd$tv,
                     ndd$refrigerator, ndd$electricity, ndd$house_floor, 
                     ndd$house_roof)
...
tbl1<- table1(~ age_months_b + sex + HAZ_b + WAZ_b + 
                       ...
                       F_house_floor + F_house_roof + cat_num_liv_hh + 
...
base_mod<- glm(control_case_group ~ age_months_b+sex+HAZ_b+F_toilet_type+
                 toilet_location+F_maternal_education+teen_mother,
...
#SES model
ses_mod<- glm(control_case_group ~ age_months_b+sex+HAZ_b+F_toilet_type+F_maternal_education+
              ,
                 data = ndd, family = "binomial")
summary(ses_mod)
